...
export default function Signup() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f6f6f6', padding: 16 }}>
      ...
      >
        <h2 style={{ fontSize: 24, fontWeight: 700, marginBottom: 24, textAlign: 'center', color: '#222' }}>Crear cuenta</h2>
        ...
        <div style={{ textAlign: 'center', marginTop: 8 }}>
          <span style={{ color: '#555', fontSize: 14 }}>¿Ya tienes cuenta? </span>
          <button type="button" style={{ background: 'none', border: 'none', color: '#007bff', textDecoration: 'underline', cursor: 'pointer', fontSize: 14 }} onClick={() => navigate('/login')}>
            Iniciar sesión
          </button>
        </div>
      </form>
